...
{
    echo '<p>connection to db established<br>incha2Allah will make sure user_name exists to connect that user<br>if user_name is not found incha2Allah will ask if user wants to redirect into register</p>';
}
else
{
    echo '
